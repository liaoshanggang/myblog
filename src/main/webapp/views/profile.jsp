                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="about_me" class="tab-pane">
                                        <div class="panel-body">
                                            <div class="">
                                                <p>
                                                <ul><li>90后程序员，主研方向：<font color="#c24f4a">Java</font>、<font color="#c24f4a">微前端</font>、<font color="#c24f4a">Node</font>。</li>
                                                ...
                                                <p>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 目前兼容人类正在使用的全部浏览器（IE6/7除外、IE8/9/10不太友好）。</p>
                                                <p>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 响应式布局、支持全设备访问（后端个别界面应功能要求不是响应式）。</p>
                                                <p>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 目前最新版本 v1.0（其余版本见说明），欢迎尝鲜。<br></p>
                                                <p>&nbsp; &nbsp; &nbsp; &nbsp; 欢迎下载尝鲜，有意见或者建议欢迎提出；QQ群：
                                                    <a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=a2db8d0fa1aa7f91fabf149d9f868efa1811e0a6839851220a9c2b2ecaf0bce7">
                                                    <img src="//pub.idqqimg.com/wpa/images/group.png" alt="笔记博客 ~ 交流反馈" title="笔记博客 ~ 交流反馈" border="0">
                                                    </a>&nbsp;<br>
                                                </p>
                                                <p><br></p>
                                            </div>
